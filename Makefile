...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2020/11/07 13:29:41 by teloise           #+#    #+#              #
#    Updated: 2020/11/18 03:38:01 by teloise          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_calloc.c ft_strdup.c ft_substr.c ft_strjoin.c ft_itoa.c ft_strmapi.c\
